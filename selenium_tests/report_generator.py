...
class ExcelReportGenerator:
    ...
    def _sheet_cover(self, stats, info):
        ...
        rows = [
            ...
            ("App/Platform",    "Flutter Web App"),
            ("Device/Browser",  info.get("device",   config.BROWSER.title())),
            ("Browser Version", info.get("version",  "Latest")),
            ("Web Server",      config.BASE_URL),
            ("Executed By",     info.get("run_by", "Selenium Automation System")),
