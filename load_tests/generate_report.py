...
def generate_report():
    ...
    wb = Workbook()
    ws = wb.active
    ws.title = "Load & Baseline Test Results"

    BLUE_FILL = PatternFill(start_color="1F4E78", end_color="1F4E78", fill_type="solid")
    WHITE_FONT = Font(color="FFFFFF", bold=True, size=11)
    GREEN_FONT = Font(color="008000", bold=True)

    ws.cell(row=2, column=2, value="Civic Reporter - Load & Baseline Test Report (400 Test Cases)").font = Font(size=14, bold=True, color="1F4E78")
    ...
    print(f"[OK] Load & Baseline 400 Test Report successfully generated:")
    print(f"   -> {target_path}")
